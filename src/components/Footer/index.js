...
import { StyledFooterContainer, AddressContainer, ContactContainer, SocialMediaContainer } from "./style"
    ...
    <StyledFooterContainer>
      ...
      <AddressContainer>
        ...
        <ContactContainer>
          ...
          <Text type="primary-small" whiteText>
            <a href={`tel:+1${footer?.[0].tel_num?.text}`}>{`+1${footer?.[0].tel_num?.text}`}</a>
          </Text>
        </ContactContainer>
        <ContactContainer>
          <Text type="primary-small" whiteText>
          ...
          <Text type="primary-small" whiteText>
            <a href={`email:${footer?.[0].email_address?.text}`}>{`${footer?.[0].email_address?.text}`}</a>
          </Text>
        </ContactContainer>
        <SocialMediaContainer>
          ...
          <LocalizedLink to={footer?.[0].social_media_ii?.url} target="_blank">
            <Instagram />
          </LocalizedLink>
          <LocalizedLink to={footer?.[0].social_media_iii?.url} target="_blank">
            <LinkedIn />
          </LocalizedLink>
          <LocalizedLink to={footer?.[0].social_media_iv?.url} target="_blank">
            <Youtube />
          </LocalizedLink>
        </SocialMediaContainer>
        <Text
