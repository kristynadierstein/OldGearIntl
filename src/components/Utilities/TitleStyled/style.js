...
export const TitleStyled = styled.span`
  ...
  &:before {
    content: "";
    border: ${(props) =>
      props.withTitleDecoration
        ? "1px solid rgba(11,31,48,1)"
        : props.withTitleDecorationWhite
        ? "1px solid white"
        : "0px"};
    width: ${(props) => (props.withTitleDecoration || props.withTitleDecorationWhite ? "20px" : "0px")};
    position: absolute;
    left: -20px;
    bottom: 5px;
